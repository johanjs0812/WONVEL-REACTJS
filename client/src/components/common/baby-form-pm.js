const BabyFormPmComponent = ({babyCount}) => {

    const Indexes = Array.from({ length: babyCount }, (_, index) => index);
        ...
        <>
            <div className="group-fields-input-contact-baby group-fields-input-contact-wrapper mb-3"  >
                <div className="title-persona" style={{display: Indexes.length === 0 ? "none" : "block"}}>
                    <img src="https://travel.com.vn/images/icons/persons/child.svg" alt="Em bé" /> Em bé    
                </div>
...
export default BabyFormPmComponent;