...
const AdultFormPmComponent = ({adultCount }) => {

    const Indexes = Array.from({ length: adultCount }, (_, index) => index);
            ...
            <div className="group-fields-input-contact-adult group-fields-input-contact-wrapper mb-3">
                ...
                {Indexes.map((index) => (
                    <form className="row" key={index}>
                        ...
                        {/* <button className="btn-delete btn-click">
...
export default AdultFormPmComponent;
