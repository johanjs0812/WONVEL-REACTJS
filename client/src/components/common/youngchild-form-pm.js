// import { YOUNGCHILD } from "../../constants/guestDate";

const YoungChildFormPmComponent = ({youngChildCount}) => {

    const Indexes = Array.from({ length: youngChildCount }, (_, index) => index);
    ...
    return(
        ...
        <div className="group-fields-input-contact-young-child group-fields-input-contact-wrapper mb-3">
            ...
            <div className="title-persona" style={{display: Indexes.length === 0 ? "none" : "block"}}>
                <img src="https://travel.com.vn/images/icons/persons/child.svg" alt="Trẻ nhỏ" /> Trẻ nhỏ 
            </div>
...
export default YoungChildFormPmComponent;